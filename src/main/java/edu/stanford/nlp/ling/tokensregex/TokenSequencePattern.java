...
public class TokenSequencePattern extends SequencePattern<CoreMap> {
  ...
  public TokenSequencePattern(String patternStr, PatternExpr nodeSequencePattern) {
...
//      return new TokenSequencePattern(string, nodeSequencePattern);
  ...
  {
    try {
      List<PatternExpr> patterns = new ArrayList<PatternExpr>();
      for (String string:strings) {
        // TODO: Check token sequence parser?
        PatternExpr pattern = env.parser.parseSequence(env, string);
        patterns.add(pattern);
      }
      PatternExpr nodeSequencePattern = new SequencePatternExpr(patterns);
   ...
   * @return Compiled TokenSequencePattern
   */
  public static TokenSequencePattern compile(PatternExpr nodeSequencePattern)
  {
