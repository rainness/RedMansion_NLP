  ...
  public Set<Entry<K, Collection<V>>> entrySet() {
    return new AbstractSet<Entry<K, Collection<V>>>() {
      ...
      public Iterator<Entry<K, Collection<V>>> iterator() {
        Filter<Entry<K, Collection<V>>> filter1 = new Filter<Entry<K, Collection<V>>>() {
          private static final long serialVersionUID = -3257173354412718639L;

          // only accepts stuff not overwritten by deltaMap
          public boolean accept(Entry<K, Collection<V>> e) {
            K key = e.getKey();
        ...
        Iterator<Entry<K, Collection<V>>> iter1 = new FilteredIterator<Entry<K, Collection<V>>>(originalMap.entrySet().iterator(), filter1);

        Filter<Entry<K, Collection<V>>> filter2 = new Filter<Entry<K, Collection<V>>>() {
          private static final long serialVersionUID = 1L;
        ...
        Iterator<Entry<K, Collection<V>>> iter2 = new FilteredIterator<Entry<K, Collection<V>>>(deltaMap.entrySet().iterator(), filter2);

        return new ConcatenationIterator<Entry<K, Collection<V>>>(iter1, iter2);
      }
